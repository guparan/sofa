...
public:
    ...
    ~ManifoldTriangleSetTopologyAlgorithms() override
    {}
     ...
     */
    int SplitAlongPath(unsigned int pa, Coord& a, unsigned int pb, Coord& b,
     ...
     */
    bool InciseAlongEdgeList(const sofa::helper::vector<unsigned int>& edges, sofa::helper::vector<unsigned int>& new_points, sofa::helper::vector<unsigned int>& end_points, bool& reachBorder) override;
