...
public:
    ...
    */
    void removeEdgesProcess(const sofa::helper::vector<unsigned int> &indices, const bool removeIsolatedItems = false) override;
    ...
    */
    void renumberPoints( const sofa::helper::vector<unsigned int> & index,
    ...
    *
    */
    void addEdges(const sofa::helper::vector< Edge >& edges) override ;
    ...
    *
    */
    void addEdges(const sofa::helper::vector< Edge >& edges,
    ...
    *
    */
    void swapEdges(const sofa::helper::vector< sofa::helper::vector< unsigned int > >& edgesPairs) override;

    /** \brief Fuse a list of pair edges, replacing each edge pair ((p11, p12), (p21, p22)) by one edge (p11, p22)
    *
    * @param removeIsolatedPoints if true isolated vertices are also removed
    */
    void fuseEdges(const sofa::helper::vector< sofa::helper::vector< unsigned int > >& edgesPairs, const bool removeIsolatedPoints = true) override;
    ...
    * @param removeIsolatedPoints if true isolated vertices are also removed
    */
    void splitEdges( sofa::helper::vector<unsigned int> &indices,
