...
public:
    ...
    /// unassembled API
    void addClambda(const core::MechanicalParams *, DataVecDeriv & res, const DataVecDeriv &lambda, SReal cfactor) override
    {
        if( m_lastDt != this->getContext()->getDt() ) reinit();
    ...
    SReal getPotentialEnergy( const core::MechanicalParams*, const DataVecCoord& ) const override { return 0; }
