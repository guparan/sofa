...
public:
    ...
    void addForce(typename Inherit::DataVecDeriv& _f , const typename Inherit::DataVecCoord& _x , const typename Inherit::DataVecDeriv& _v, const helper::vector<SReal> _vol) override
     {
...
protected:
    ...
    ~HookeOrthotropicForceField() override     {    }
};
...
protected:
    ...
    ~HookeTransverseForceField() override     {    }
};
}
}
}
