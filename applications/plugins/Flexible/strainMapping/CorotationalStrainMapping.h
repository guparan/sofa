...
public:
    ...
    */
    ...
    void initJacobianBlock( helper::vector<BlockType>& jacobianBlock ) override
    {
...
protected:
    ...
    ~CorotationalStrainMapping() override { }

    void applyBlock(Data<typename Inherit::OutVecCoord>& dOut, const Data<typename Inherit::InVecCoord>& dIn, helper::vector<BlockType>& jacobianBlock) override
    {
