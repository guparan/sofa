...
public:
    ...
    /// @name Component API
    /// @{
    void init() override; /// call when initializing the simulation
    void draw( const core::visual::VisualParams* vparams ) override; /// debug drawing
