...
class SOFA_COMPONENT_MASS_API BeamMassMatrix : public core::behavior::Mass<DataTypes>
{
public:
...
#if !defined(SOFA_COMPONENT_MASS_BEAMMASSMATRIX_CPP)
#ifndef SOFA_FLOAT
extern template class SOFA_COMPONENT_MASS_API BeamMassMatrix<defaulttype::Rigid3dTypes, double>;
#endif
#ifndef SOFA_DOUBLE
extern template class SOFA_COMPONENT_MASS_API BeamMassMatrix<defaulttype::Rigid3fTypes, float>;
#endif
#endif
