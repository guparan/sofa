...
#ifndef SOFA_FLOAT
template class SOFA_COMPONENT_MASS_API BeamMassMatrix<defaulttype::Rigid3dTypes,double>;
#endif
#ifndef SOFA_DOUBLE
template class SOFA_COMPONENT_MASS_API BeamMassMatrix<defaulttype::Rigid3fTypes,float>;
#endif
