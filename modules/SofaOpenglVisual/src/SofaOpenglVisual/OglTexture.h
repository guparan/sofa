...
class SOFA_SOFAOPENGLVISUAL_API OglTexture :  public core::visual::VisualModel, public OglShaderElement
{
public:
...
class SOFA_SOFAOPENGLVISUAL_API OglTexture2D : public OglTexture
{
public:
