...
extern template class SOFA_SOFAMESHCOLLISION_API ContactMapper<LineModel, sofa::defaulttype::Vec3Types>;
extern template class SOFA_SOFAMESHCOLLISION_API ContactMapper<TriangleModel, sofa::defaulttype::Vec3Types>;
extern template class SOFA_SOFAMESHCOLLISION_API ContactMapper<CapsuleModel, sofa::defaulttype::Vec3Types>;

#  ifdef _MSC_VER
// Manual declaration of non-specialized members, to avoid warnings from MSVC.
extern template SOFA_SOFAMESHCOLLISION_API void BarycentricContactMapper<LineModel, defaulttype::Vec3Types>::cleanup();
extern template SOFA_SOFAMESHCOLLISION_API core::behavior::MechanicalState<defaulttype::Vec3Types>* BarycentricContactMapper<LineModel, defaulttype::Vec3Types>::createMapping(const char*);
extern template SOFA_SOFAMESHCOLLISION_API void BarycentricContactMapper<TriangleModel, defaulttype::Vec3Types>::cleanup();
extern template SOFA_SOFAMESHCOLLISION_API core::behavior::MechanicalState<defaulttype::Vec3Types>* BarycentricContactMapper<TriangleModel, defaulttype::Vec3Types>::createMapping(const char*);
extern template SOFA_SOFAMESHCOLLISION_API void BarycentricContactMapper<CapsuleModel, defaulttype::Vec3Types>::cleanup();
extern template SOFA_SOFAMESHCOLLISION_API core::behavior::MechanicalState<defaulttype::Vec3Types>* BarycentricContactMapper<CapsuleModel, defaulttype::Vec3Types>::createMapping(const char*);
#  endif // _MSC_VER
#endif
