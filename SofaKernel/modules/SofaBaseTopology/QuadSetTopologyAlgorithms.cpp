...
int QuadSetTopologyAlgorithmsClass = core::RegisterObject("Quad set topology algorithms")
        ...
        ;
template class SOFA_SOFABASETOPOLOGY_API QuadSetTopologyAlgorithms<Vec3Types>;
template class SOFA_SOFABASETOPOLOGY_API QuadSetTopologyAlgorithms<Vec2Types>;
template class SOFA_SOFABASETOPOLOGY_API QuadSetTopologyAlgorithms<Vec1Types>;
