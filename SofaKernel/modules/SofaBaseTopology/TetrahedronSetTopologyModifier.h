...
public:
    ...
    */
    void removeTrianglesProcess(const sofa::helper::vector<unsigned int> &indices,
    ...
    */
    void removeEdgesProcess( const sofa::helper::vector<unsigned int> &indices,
    ...
    * \sa addPointsWarning
    */
    void addPointsProcess(const unsigned int nPoints) override;
    ...
    */
    void removePointsProcess(const sofa::helper::vector<unsigned int> &indices, const bool removeDOF = true) override;
    ...
    */
    void renumberPointsProcess( const sofa::helper::vector<unsigned int> &index,
