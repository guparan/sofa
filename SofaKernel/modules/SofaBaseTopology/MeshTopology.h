...
public:
    ...
    int getNbEdges() override;
    int getNbTriangles() override;
    int getNbQuads() override;
    int getNbTetrahedra() override;
    int getNbHexahedra() override;
    ...
    const helper::vector<unsigned int> getConnectedElement(unsigned int elem) override;

    /// Returns the set of element indices adjacent to a given element (i.e. sharing a link)
    const helper::vector<unsigned int> getElementAroundElement(unsigned int elem) override;
    /// Returns the set of element indices adjacent to a given list of elements (i.e. sharing a link)
    const helper::vector<unsigned int> getElementAroundElements(helper::vector<unsigned int> elems) override;
    /// @}
