...
int HexahedronSetTopologyAlgorithmsClass = core::RegisterObject("Hexahedron set topology algorithms")
        ...
        ;
template class SOFA_SOFABASETOPOLOGY_API HexahedronSetTopologyAlgorithms<Vec3Types>;
template class SOFA_SOFABASETOPOLOGY_API HexahedronSetTopologyAlgorithms<Vec2Types>;
template class SOFA_SOFABASETOPOLOGY_API HexahedronSetTopologyAlgorithms<Vec1Types>;
