...
int EdgeSetTopologyAlgorithmsClass = core::RegisterObject("Edge set topology algorithms")
        ...
        ;
template class SOFA_SOFABASETOPOLOGY_API EdgeSetTopologyAlgorithms<Vec3Types>;
template class SOFA_SOFABASETOPOLOGY_API EdgeSetTopologyAlgorithms<Vec2Types>;
template class SOFA_SOFABASETOPOLOGY_API EdgeSetTopologyAlgorithms<Vec1Types>;
template class SOFA_SOFABASETOPOLOGY_API EdgeSetTopologyAlgorithms<Rigid3Types>;
template class SOFA_SOFABASETOPOLOGY_API EdgeSetTopologyAlgorithms<Rigid2Types>;
