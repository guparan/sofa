...
template class SOFA_SOFABASETOPOLOGY_API TetrahedronSetTopologyAlgorithms<Vec3Types>;
template class SOFA_SOFABASETOPOLOGY_API TetrahedronSetTopologyAlgorithms<Vec2Types>;
template class SOFA_SOFABASETOPOLOGY_API TetrahedronSetTopologyAlgorithms<Vec1Types>;
