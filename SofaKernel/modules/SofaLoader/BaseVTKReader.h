...
public:
    ...
    public:
        ...
        void swap() override ;
        bool read(const string& s, int n, int binary) override ;
        bool read(const string& s, int binary) override ;
        bool read(istream& in, int n, int binary) override ;
        bool write(ofstream& out, int n, int groups, int binary) override ;
