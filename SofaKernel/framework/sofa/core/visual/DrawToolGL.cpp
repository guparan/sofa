...
template class SOFA_SOFACORE_API BasicShapesGL_Sphere< sofa::defaulttype::Vector3 >;
template class SOFA_SOFACORE_API BasicShapesGL_FakeSphere< sofa::defaulttype::Vector3 >;
