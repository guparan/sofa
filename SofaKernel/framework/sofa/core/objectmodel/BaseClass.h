...
#define SOFA_ABSTRACT_CLASS(T,Parent) \
    SOFA_FRAMEWORK_ABSTRACT_CLASS(T,Parent); \
    virtual void Init() override { Inherit1::Init(); T::init(); }
...
#define SOFA_CLASS2(T,Parent1,Parent2) \
    SOFA_FRAMEWORK_CLASS2(T,Parent1,Parent2); \
    virtual void Init() override { Inherit1::Init(); T::init(); }
...
#define SOFA_ABSTRACT_CLASS2(T,Parent1,Parent2) \
    SOFA_FRAMEWORK_ABSTRACT_CLASS2(T,Parent1,Parent2); \
    virtual void Init() override { Inherit1::Init(); T::init(); }
...
// This macro should now be used at the beginning of all declarations of classes with 6 base classes
