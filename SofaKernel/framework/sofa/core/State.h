...
extern template class SOFA_SOFACORE_API State<defaulttype::Vec3dTypes>;
extern template class SOFA_SOFACORE_API State<defaulttype::Vec2Types>;
extern template class SOFA_SOFACORE_API State<defaulttype::Vec1Types>;
extern template class SOFA_SOFACORE_API State<defaulttype::Vec6Types>;
extern template class SOFA_SOFACORE_API State<defaulttype::Rigid3Types>;
extern template class SOFA_SOFACORE_API State<defaulttype::Rigid2Types>;
extern template class SOFA_SOFACORE_API State<defaulttype::ExtVec3Types>;


extern template class SOFA_SOFACORE_API State<defaulttype::ExtVec3fTypes>;
