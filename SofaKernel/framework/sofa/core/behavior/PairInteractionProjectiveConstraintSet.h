...
extern template class SOFA_SOFACORE_API PairInteractionProjectiveConstraintSet<defaulttype::Vec3Types>;
extern template class SOFA_SOFACORE_API PairInteractionProjectiveConstraintSet<defaulttype::Vec2Types>;
extern template class SOFA_SOFACORE_API PairInteractionProjectiveConstraintSet<defaulttype::Vec1Types>;
extern template class SOFA_SOFACORE_API PairInteractionProjectiveConstraintSet<defaulttype::Rigid3Types>;
extern template class SOFA_SOFACORE_API PairInteractionProjectiveConstraintSet<defaulttype::Rigid2Types>;
