...
extern template class SOFA_SOFACORE_API ProjectiveConstraintSet< defaulttype::Vec6Types >;
extern template class SOFA_SOFACORE_API ProjectiveConstraintSet< defaulttype::Vec3Types >;
extern template class SOFA_SOFACORE_API ProjectiveConstraintSet< defaulttype::Vec2Types >;
extern template class SOFA_SOFACORE_API ProjectiveConstraintSet< defaulttype::Vec1Types >;
extern template class SOFA_SOFACORE_API ProjectiveConstraintSet< defaulttype::Rigid3Types >;
extern template class SOFA_SOFACORE_API ProjectiveConstraintSet< defaulttype::Rigid2Types >;
