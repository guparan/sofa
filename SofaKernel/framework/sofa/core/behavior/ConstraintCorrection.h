...
extern template class SOFA_SOFACORE_API ConstraintCorrection< sofa::defaulttype::Vec3Types >;
extern template class SOFA_SOFACORE_API ConstraintCorrection< sofa::defaulttype::Vec2Types >;
extern template class SOFA_SOFACORE_API ConstraintCorrection< sofa::defaulttype::Vec1Types >;
extern template class SOFA_SOFACORE_API ConstraintCorrection< sofa::defaulttype::Rigid3Types >;
