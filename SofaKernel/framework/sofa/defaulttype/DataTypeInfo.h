...
public:
    ...
    std::string name() const override { return DataTypeName<DataType>::name(); }
    ...
    std::string getTextValue   (const void* data, size_t index) const override
    {
        std::string v;
    ...
    void setTextValue(void* data, size_t index, const std::string& value) const override
    {
    ...
    const std::type_info* type_info() const override { return &typeid(DataType); }
