 ...
 */
class SOFA_SOFASIMULATIONCORE_API Simulation: public virtual sofa::core::objectmodel::Base
{
public:
...
SOFA_SOFASIMULATIONCORE_API void setSimulation(Simulation* s);

/** Get the (unique) simulation which controls the scene.
    Automatically creates one if no Simulation has been set.
 */
SOFA_SOFASIMULATIONCORE_API Simulation* getSimulation();
