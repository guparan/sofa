...
class SOFA_SOFASIMULATION_API InitGnuplotVisitor : public simulation::Visitor
{
public:
...
class SOFA_SOFASIMULATION_API ExportGnuplotVisitor : public simulation::Visitor
{
public:
