...
class SOFA_SOFASIMULATIONCORE_API InitGnuplotVisitor : public simulation::Visitor
{
public:
...
class SOFA_SOFASIMULATIONCORE_API ExportGnuplotVisitor : public simulation::Visitor
{
public:
