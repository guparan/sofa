...
/** Print a vector */
class SOFA_SOFASIMULATIONCORE_API MechanicalVPrintVisitor : public Visitor
{
public:
...
class SOFA_SOFASIMULATIONCORE_API MechanicalVPrintWithElapsedTimeVisitor : public Visitor
{
protected:
    sofa::core::ConstMultiVecId v_;
    unsigned count_;
...
class SOFA_SOFASIMULATIONCORE_API DofPrintVisitor : public Visitor
{
public:
